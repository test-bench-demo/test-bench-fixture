    ...
    module Automated
      class Output
        class Device
          ...
          def buffering
            @buffering.nil? ? @buffering = false : @buffering
          end
          attr_writer :buffering
          alias :buffering? :buffering
          ...
          module Defaults
            def self.target_device
              env_target_device = ENV.fetch('TEST_OUTPUT_DEVICE') do
                STDOUT.sync = true
